...
4. **Настоящий Open Source** -- Лицензия AGPL-3.0, никаких ограничений "fair-code", разработка, управляемая сообществом
...
| 📧 **Email** | Прямой контакт с мейнтейнерами | support@fluxturn.com |

...
- **80+ कनेक्टर** -- Slack, Gmail, Shopify, HubSpot, Jira, Stripe, OpenAI, और भी बहुत कुछ
...
**बैकएंड** (`/backend`) -- NestJS, PostgreSQL (raw SQL), Redis, Socket.IO, LangChain, 80+ कनेक्टर

## कनेक्टर

FluxTurn इन श्रेणियों में 80+ कनेक्टर के साथ आता है:

| श्रेणी | कनेक्टर |
|----------|-----------|
| **संचार** | Slack, Gmail, Outlook, Telegram, Discord, Twilio, SendGrid, Microsoft Teams |
| **CRM और बिक्री** | HubSpot, Salesforce, Pipedrive, Zoho CRM, Airtable |
| **ई-कॉमर्स** | Shopify, Stripe, PayPal, WooCommerce, Paddle, Gumroad |
| **प्रोजेक्ट मैनेजमेंट** | Jira, Asana, Trello, Notion, Linear, ClickUp |
| **सोशल** | Twitter/X, Facebook, Instagram, TikTok, LinkedIn, Pinterest |
| **AI और ML** | OpenAI, Anthropic, Google AI, AWS Bedrock, Ollama, Replicate |
| **एनालिटिक्स** | PostHog, Mixpanel, Segment, Grafana, Metabase, Splunk |
| **स्टोरेज** | Google Drive, Dropbox, AWS S3, PostgreSQL, Snowflake, Supabase |
| **समर्थन** | Zendesk, Intercom, ServiceNow, PagerDuty, Sentry |
| **वित्त** | QuickBooks, Plaid, Chargebee, Wise |
| **मार्केटिंग** | Mailchimp, Klaviyo, Facebook Ads |

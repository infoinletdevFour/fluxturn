...
- **৮০+ কানেক্টর** -- Slack, Gmail, Shopify, HubSpot, Jira, Stripe, OpenAI, এবং আরও অনেক কিছু
...
**ব্যাকএন্ড** (`/backend`) -- NestJS, PostgreSQL (raw SQL), Redis, Socket.IO, LangChain, ৮০+ কানেক্টর

## কানেক্টর

FluxTurn এই শ্রেণীগুলিতে ৮০+ কানেক্টর সহ আসে:

| শ্রেণী | কানেক্টর |
|----------|-----------|
| **যোগাযোগ** | Slack, Gmail, Outlook, Telegram, Discord, Twilio, SendGrid, Microsoft Teams |
| **CRM এবং বিক্রয়** | HubSpot, Salesforce, Pipedrive, Zoho CRM, Airtable |
| **ই-কমার্স** | Shopify, Stripe, PayPal, WooCommerce, Paddle, Gumroad |
| **প্রজেক্ট ম্যানেজমেন্ট** | Jira, Asana, Trello, Notion, Linear, ClickUp |
| **সোশ্যাল** | Twitter/X, Facebook, Instagram, TikTok, LinkedIn, Pinterest |
| **AI এবং ML** | OpenAI, Anthropic, Google AI, AWS Bedrock, Ollama, Replicate |
| **অ্যানালিটিক্স** | PostHog, Mixpanel, Segment, Grafana, Metabase, Splunk |
| **স্টোরেজ** | Google Drive, Dropbox, AWS S3, PostgreSQL, Snowflake, Supabase |
| **সাপোর্ট** | Zendesk, Intercom, ServiceNow, PagerDuty, Sentry |
| **অর্থ** | QuickBooks, Plaid, Chargebee, Wise |
| **মার্কেটিং** | Mailchimp, Klaviyo, Facebook Ads |

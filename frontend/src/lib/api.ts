...
class ApiClient {
  ...
  async getPaymentConfig(organizationId?: string, projectId?: string, appId?: string): Promise<any> {
    // Set context IDs if provided
    if (organizationId) this.setOrganizationId(organizationId);
    if (projectId) this.setProjectId(projectId);
    if (appId) this.setAppId(appId);

    return this.get('/tenant-payment/config');
  }
  ...
  async createPaymentConfig(config: {
    ...
    return this.post('/tenant-payment/config', config);
  }
  ...
  async updatePaymentConfig(config: {
    ...
    return this.put('/tenant-payment/config', config);
  }

  async deletePaymentConfig(organizationId?: string, projectId?: string, appId?: string): Promise<any> {
    // Set context IDs if provided
    if (organizationId) this.setOrganizationId(organizationId);
    if (projectId) this.setProjectId(projectId);
    if (appId) this.setAppId(appId);

    return this.delete('/tenant-payment/config');
  }
  ...
  async createPaymentSession(params: {
    ...
    return this.post('/tenant-payment/session', params);
  }
  ...
  async createSubscription(params: {
    ...
    return this.post('/tenant-payment/subscription', params);
  }
  ...
  async getPaymentTransactions(params?: {
    ...
    const query = searchParams.toString();
    return this.get(`/tenant-payment/transactions${query ? `?${query}` : ''}`);
  }
  ...
  async createCustomerPortalSession(params: {
    ...
    return this.post('/tenant-payment/portal', params);
  }

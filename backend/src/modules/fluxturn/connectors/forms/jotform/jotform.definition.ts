// Jotform Connector Definition (Forms Category)
// Full definition with aiControlled fields for AI agent support
 ...
 */
export const JOTFORM_FORM_CONNECTOR: ConnectorDefinition = {
  name: 'jotform_forms',
  display_name: 'JotForm (Forms)',
  category: 'forms',
    ...
    },
    {
      ...
      inputSchema: {
        ...
        submissionData: {
          ...
          aiControlled: true,
          aiDescription: 'Generate form submission data with field values matching the form questions. Use question IDs as keys and provide appropriate values for each field.'
        }
      },
      outputSchema: {
    ...
    },
    {
      ...
      inputSchema: {
        ...
        submissionData: {
          ...
          aiControlled: true,
          aiDescription: 'Generate updated form submission data with new field values. Use question IDs as keys and provide the updated values for each field to modify.'
        }
      },
      outputSchema: {
